  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-900 dark:bg-dark-900 dark:text-gray-100">
      <div className="max-w-3xl mx-auto px-4 py-12 md:py-16">
        ...
        <section className="space-y-4 text-sm md:text-base leading-relaxed bg-white/90 dark:bg-dark-400/90 border border-gray-200/70 dark:border-dark-300 rounded-2xl shadow-sm p-6 md:p-7">
          <p>
